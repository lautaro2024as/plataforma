...
from administrador.omega_local_wallpaper import (
    activate as wallpaper_activate,
    delete as wallpaper_delete,
    listing as wallpaper_list,
    panel as wallpaper_panel,
    preview as wallpaper_preview,
    upload as wallpaper_upload,
    video as wallpaper_video,
)
