...
from administrador.omega_portable2 import activate as portable_activate, delete_bundle as portable_delete, import_bundle as portable_import, listing as portable_list, panel as portable_panel, preview as portable_preview
...
urlpatterns = [
    ...
    path('admin/omega/wallpapers/delete/', portable_delete, name='omega-wallpaper-delete'),
